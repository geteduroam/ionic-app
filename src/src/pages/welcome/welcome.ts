...
export class WelcomePage {
  ...
  async configure() {
    ...
    /*await WifiEapConfigurator.test({
      ssid: "eduroam", username: "iagtprof@alu.upo.es", password: "4cHK6kbj", eap: 21, servername: "radius.upo.es", auth: 1,
     ...
     await WifiEapConfigurator.test({ssid: "eduroam", username: "emergya@ad.eduroam.no", password: "crocodille", eap: 25, servername: "eduroam.uninett.no", auth: 3, 
